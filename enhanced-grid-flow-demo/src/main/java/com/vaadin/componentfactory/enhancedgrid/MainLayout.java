...
public class MainLayout extends AppLayout {
    ...
    public MainLayout() {
        ...
        final RouterLink dialogExample = new RouterLink("Dialog example", DialogExampleView.class);

        final VerticalLayout menuLayout = new VerticalLayout(simpleSingleGrid, simpleMultiGrid, lazySingleGrid, lazyMultiGrid, 
        		singleTree, multiTree, lazySingleTree, lazyMultiTree, customFilterIcon, dialogExample
        );
